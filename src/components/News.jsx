        ...
        <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3'>
            ...
            <div className='my-4'>
                <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
                    ...
                    <button className='bg-[#00df9a] w-[200px] rounded-full font-medium ml-4 my-6 px-6 py-3 text-black'>Notify me</button>
                </div>
                <p className='md:text-left sm:text-center'>Read our <span className='text-[#00df9a]'>Privacy Policy</span></p>
            </div>
        </div>
    </div>
  )
