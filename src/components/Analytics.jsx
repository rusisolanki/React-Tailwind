  ...
  return (
    <div className='w-full bg-white py-16 px-4'>
        ...
        <div className='flex flex-col justify-center'>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro et nulla molestias a odio laboriosam. Impedit delectus veritatis sapiente atque fuga natus ad assumenda, fugit possimus expedita consequuntur facere? Consectetur?</p>
