...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center h-24 mx-auto px-4 text-white">
      ...
      <div className={nav ? "fixed left-0 top-0 w-[50%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-500": 'fixed left-[-100%] ease-in-out duration-500'}>
